#!/usr/bin/env node
/**
 * normalize-statuses.mjs — Clean non-canonical states in enrollments.md
 *
 ...
 *
 * Run: node learn-ops/normalize-statuses.mjs [--dry-run]
 */
...
if (!existsSync(APPS_FILE)) {
  console.log('No enrollments.md found. Nothing to normalize.');
  process.exit(0);
}
