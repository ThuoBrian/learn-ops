# Learn-Ops on the Free Tier (Antigravity CLI)

learn-ops works with **Antigravity CLI's free tier** — no API key or paid
...
a rate-limit error; learn-ops will pause and suggest retrying tomorrow.
