 ...
 * link in enrollments.md must be relative to wherever that tracker file lives:
 * `../reports/...` when the tracker is at `data/enrollments.md`, or
 ...
 * @param {string} trackerDir   Absolute dir of the tracker file (dirname of enrollments.md).
