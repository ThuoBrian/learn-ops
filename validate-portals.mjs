...
/**
 * validate-portals.mjs — schema/shape validator for learning-portals.yml.
 *
 * Usage:
...
async function runSelfTest() {
  const tmp = mkdtempSync(join(tmpdir(), 'learn-ops-validate-portals-self-test-'));
  try {
...
async function main() {
  ...
  if (!filePath) {
    console.error('Usage: node validate-portals.mjs [--file learning-portals.yml] [--self-test]');
    process.exit(1);
  }
