...
// Ensures every supported CLI gets .*/skills/learn-ops/SKILL.md even when the
...
export const CANONICAL_SKILL_PATH = '.agents/skills/learn-ops/SKILL.md';

export const SKILL_ENTRYPOINTS = [
  {
    path: '.claude/skills/learn-ops/SKILL.md',
    pointer: '../../../.agents/skills/learn-ops/SKILL.md',
  },
  {
    path: '.opencode/skills/learn-ops/SKILL.md',
    pointer: '../../../.agents/skills/learn-ops/SKILL.md',
  },
  {
    path: '.qwen/skills/learn-ops/SKILL.md',
    pointer: '../../../.agents/skills/learn-ops/SKILL.md',
  },
  {
    path: '.antigravitycli/skills/learn-ops/SKILL.md',
    pointer: '../../../.agents/skills/learn-ops/SKILL.md',
  },
  {
    path: '.grok/skills/learn-ops/SKILL.md',
    pointer: '../../../.agents/skills/learn-ops/SKILL.md',
  },
  {
    path: '.kimi/skills/learn-ops/SKILL.md',
    pointer: '../../../.agents/skills/learn-ops/SKILL.md',
  },
];
